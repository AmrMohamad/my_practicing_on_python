...
## my second programm in Python 😅 ✌🏻

### Instructions

It's a simple game, choose right answars 🥇

the code of game based on if statement in Python
...
You prepared yourself to go looking for treasure.
